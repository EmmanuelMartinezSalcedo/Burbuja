...
var fish_spawn_interval: float = 10.0  # Intervalo de tiempo entre los spawns de los peces
var turtle_spawn_interval: float = 15.0  # Intervalo de tiempo entre los spawns de las tortugas
...
func spawn_turtle() -> void:
	...
	get_parent().get_parent().add_child(turtle_instance)
